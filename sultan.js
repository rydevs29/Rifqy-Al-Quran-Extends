...
// SINKRONISASI TRACKER AMAN DARI CRASH
let rawTracker = window.syncStorage.getItem('rTracker');
window.trackerData = rawTracker ? JSON.parse(rawTracker) : { Subuh:false, Dzuhur:false, Ashar:false, Maghrib:false, Isya:false, Puasa:false, Tarawih:false };
